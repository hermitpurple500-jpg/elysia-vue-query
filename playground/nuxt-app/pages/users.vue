  ...
  <div>
      ...
      <form class="create-form" @submit.prevent="handleCreate">
        ...
        <div style="display: flex; align-items: center; gap: 0.875rem">
          ...
          <Transition name="fade">
            <span v-if="showSuccess" class="success-box"> ✓ Created — list auto-refreshed! </span>
          </Transition>
        </div>
        <p
        ...
        <div v-for="user in users" :key="user.id" class="row-item">
          ...
          <button
            ...
            :disabled="
              ...
              deleteMutation.variables.value?.params.id === user.id.toString()
            "
          >
            Delete
          </button>
    ...
    <div class="card section">
      ...
      <div class="code-block">
        ...
        {{ JSON.stringify(queryKey, replacer, 2) }}
      </div>
    </div>
  </div>
</template>
