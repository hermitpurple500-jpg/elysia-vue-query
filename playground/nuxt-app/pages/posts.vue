<template>
  <div>
    <div class="page-header">
      ...
      <p class="page-desc">
        Create and browse posts. Cache invalidation means publishing a post immediately updates the
        list — no manual
        <code
          style="
      ...
      <form class="create-form" @submit.prevent="handleCreate">
        ...
        <div style="display: flex; align-items: center; gap: 0.875rem">
          <button
            type="submit"
            class="btn-primary"
            :disabled="createMutation.isPending.value || !userId"
            style="
        ...
        <p
          ...
          style="font-size: 0.75rem; color: #f87171; margin-top: 0.5rem"
        >
          ...
          >
            ...
            <button
              ...
              :disabled="
                ...
                deleteMutation.variables.value?.params.id === post.id.toString()
              "
            >
              Delete
            </button>
