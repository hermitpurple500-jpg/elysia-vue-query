...
const posts: Post[] = [
  { id: 1, userId: 1, title: 'Getting Started with Elysia', body: 'Elysia is a fast, type-safe web framework built for Bun...' },
  { id: 2, userId: 1, title: 'Eden Treaty Deep Dive', body: 'Eden Treaty provides end-to-end type safety between your server and client...' },
  { id: 3, userId: 2, title: 'Vue Query Patterns', body: 'TanStack Query for Vue brings powerful data fetching primitives...' },
]
