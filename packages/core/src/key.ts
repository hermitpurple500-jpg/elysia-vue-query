...
export function buildMutationInvalidationKey(enhanced: unknown): readonly [typeof EDEN_ROUTE_SYMBOL, ...string[]] {
  const meta = getRouteMeta(enhanced)
...
export function buildPartialKey(...segments: readonly string[]): readonly [typeof EDEN_ROUTE_SYMBOL, ...string[]] {
